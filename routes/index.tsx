...
import { PoliticsPage } from "../components/game/PoliticsPage";
...
type View = "life" | "education" | "careers" | "politics" | "internships" | "resume" | "profile";
...
function Index() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-3 py-3 sm:px-4">
      ...
      <div className="mt-3 flex gap-1.5 rounded-2xl bg-white/5 p-1">
        {NAV.map((n) => {
          const Icon = n.icon;
      ...
      {view === "politics" && (
        <div className="mt-3">
          <PoliticsPage character={c} act={game.politicsAction} />
        </div>
      )}
